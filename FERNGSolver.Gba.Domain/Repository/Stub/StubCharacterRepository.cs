...
{
    public class StubCharacterRepository : ICharacterRepository
    {
        protected ICharacter[] Characters { get; init; }
        public IReadOnlyList<ICharacter> AllCharacters => Characters;

        protected class Character : ICharacter
        {
        ...
        protected StubCharacterRepository()
        {
            Characters = Array.Empty<ICharacter>();
        }
    }

    public sealed class StubBindingBladeCharacterRepository : StubCharacterRepository
    {
        public StubBindingBladeCharacterRepository()
        {
    ...
    public sealed class StubBlazingBladeCharacterRepository : StubCharacterRepository
    {
        public StubBlazingBladeCharacterRepository()
        {
            ICharacter[] characters = [
    ...
    public sealed class StubSacredStonesCharacterRepository : StubCharacterRepository
    {
        public StubSacredStonesCharacterRepository()
        {
            ...
            Characters = character1.OrderBy(character => character.Name)
                .Concat(character2.OrderBy(character => character.Name))
                .ToArray();
        }
    }
}

...
{
    internal partial class SacredStonesUnitStatusDetailDialog : Form, IUnitStatusDetailDialog
    {
        ...
        public SacredStonesUnitStatusDetailDialog(IUnitStatusDetail currentStatus)
        {
            InitializeComponent();

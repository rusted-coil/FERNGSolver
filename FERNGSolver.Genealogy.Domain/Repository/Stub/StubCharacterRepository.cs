...
namespace FERNGSolver.Genealogy.Domain.Repository.Stub
{
    public sealed class StubCharacterRepository : ICharacterRepository
    {
        ...
        public StubCharacterRepository()
        {
            ...
            ICharacter[] children = [
                AddFixedCharacter(new FixedCharacterMaster("セリス",140,55,30,45,60,35,45,30, ("バルド", 4), ("ナーガ", 2))),
                AddFixedCharacter(new FixedCharacterMaster("オイフェ",100,40,5,30,50,30,40,10, ("バルド", 2))),
                AddFixedCharacter(new FixedCharacterMaster("ユリア",90,10,100,10,20,30,30,50, ("ナーガ", 4), ("ファラ", 2))),
                AddFixedCharacter(new FixedCharacterMaster("ヨハルヴァ",110,40,0,60,50,10,10,5, ("ネール", 2))),
                AddFixedCharacter(new FixedCharacterMaster("ヨハン",110,40,5,60,20,50,10,5, ("ネール", 2))),
                AddFixedCharacter(new FixedCharacterMaster("シャナン",120,30,5,40,80,20,20,5, ("オード", 4))),
                AddFixedCharacter(new FixedCharacterMaster("アレス",130,90,5,40,20,30,50,30, ("ヘズル", 4))),
                AddFixedCharacter(new FixedCharacterMaster("リーフ",130,60,7,50,50,45,25,10, ("バルド", 2), ("ノヴァ", 2))),
                AddFixedCharacter(new FixedCharacterMaster("ハンニバル",60,50,5,30,10,10,10,5)),
                AddFixedCharacter(new FixedCharacterMaster("アルテナ",135,65,7,55,45,60,25,12, ("バルド", 2), ("ノヴァ", 4))),
            ...
            ICharacter[] alter = [
                ...
                AddFixedCharacter(new FixedCharacterMaster("アミッド",90,20,40,20,50,40,20,20, ("トード", 2))),
                ...
                AddFixedCharacter(new FixedCharacterMaster("リンダ",90,10,40,10,40,30,20,20, ("トード", 2))),
